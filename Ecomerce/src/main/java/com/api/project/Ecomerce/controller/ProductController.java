...
public class ProductController {
    ...
    public ApiResponse<ProductResponse> createProduct(
        ...
        log.info("ProductController - createProduct called: requestType={}", request == null ? "null" : request.getClass().getSimpleName());

        ProductResponse response = productService.createProduct(request);

        log.info("ProductController - Product created: productId={}", response == null ? "null" : response.getId());
    ...
    public ApiResponse<ProductResponse> updateProduct(
        ...
        log.info("ProductController - updateProduct called: id={}, requestType={}", id, request == null ? "null" : request.getClass().getSimpleName());
    ...
    public ApiResponse<ProductResponse> getProductById(
        ...
        log.info("ProductController - getProductById returned: productId={}", product == null ? id : product.getId());
    ...
    public ApiResponse<Page<ProductResponse>> getProductsByCategory(
        ...
        log.info("ProductController - getProductsByCategory called: categoryId={}, page={}, size={}", categoryId, page, size);
